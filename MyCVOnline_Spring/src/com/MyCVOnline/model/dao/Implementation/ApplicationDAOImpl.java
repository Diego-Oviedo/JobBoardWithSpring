...
public class ApplicationDAOImpl extends AbstractDAO<Application> implements ApplicationDAO {
	...
	public ArrayList<Application> retreiveApplicationsByCompany(String companyID) {
		...
		Query query = getSession().createQuery("FROM APPLICATIONS WHERE position_id IN ( position_id FROM COMPANIES WHERE company_id :companyID ) ");
	...
	public ArrayList<Application> retreiveApplicationsByCity(String city) {
		...
		Query query = getSession().createQuery("FROM APPLICATIONS WHERE position_id IN ( position_id FROM COMPANIES c WHERE c.city :city UNION FROM APPLICANTS a WHERE a.city :city ) ");
	...
	public ArrayList<Application> retreiveApplicationsByDomain(String domain) {
		...
		Query query = getSession().createQuery("FROM APPLICATIONS WHERE position_id IN ( position_id FROM COMPANIES WHERE job_domain :domain ) ");
	...
	public ArrayList<Application> retreiveApplicationsByCountry(String country) {
		...
		Query query = getSession().createQuery("FROM APPLICATIONS WHERE position_id IN ( position_id FROM COMPANIES c WHERE c.country :country UNION FROM APPLICANTS a WHERE a.country :country ) ");
